    ...
    app.get('/btc-payout-balance', async (req, res) => {
      ...
      try {
        ...
        console.log('[DEBUG] Raw Blockonomics API Response Headers:', JSON.stringify(response.headers, null, 2));
        ...
        if (response.data && Array.isArray(response.data.response) && response.data.response.length > 0) {
          ...
          console.error('[BTC Balance Error] Blockonomics response.data.response is not an array or is empty:');
          console.error('Full response.data:', JSON.stringify(response.data, null, 2)); // Log full data again
        ...
        if (error.response) {
          console.error('Blockonomics API Error Response Status:', error.response.status);
          console.error('Blockonomics API Error Response Headers:', JSON.stringify(error.response.headers, null, 2));
          console.error('Blockonomics API Error Response Data (from error.response):', JSON.stringify(error.response.data, null, 2));
