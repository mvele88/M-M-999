...
<body>
  ...
  <script>
    ...
    const TRITON_ONE_RPC = "https://rpc.triton.one/solana";
    ...
    // Create connection with Triton One RPC instead of default cluster API
    const connection = new solanaWeb3.Connection(TRITON_ONE_RPC, "confirmed");
    ...
    async function checkBalance() {
      try {
        ...
        const usd = sol * 150; // You can replace 150 with dynamic price later
        return usd;
      } catch (err) {
